...
<div class="topo" id="topo">
    <div class="container">
        <h1><a href=""><img class="logo" src="./img/logo-composta.svg" alt="Logo da agência Alpaca Web."></a></h1>
        <label class="open-menu" for="menu-input"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars" class="svg-inline--fa fa-bars fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z"></path></svg></label>
        <input id="menu-input" name="menu-input" type="checkbox" />
        <nav>
            <ul class="menu">
                <label class="open-menu" for="menu-input">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="times" class="svg-inline--fa fa-times fa-w-11" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z"></path></svg>
                </label>
                <div class="blob">
                    <img class="alpacaweb" src="./img/alpacaweb.svg" alt="Alpaca Web.">
                    <img class="alpaca" src="./img/alpaca-olho.svg" alt="Desenho de uma alpaca. Símbolo da agência Alpaca Web.">
                </div>
                <li><a data-go="servicos" class="go">Serviços</a></li>
                <li><a data-go="sobre" class="go">Quem Somos</a></li>
                <li><a data-go="clientes" class="go">Clientes &amp; Parceiros</a></li>
                <li class="whatsapp"><a href="https://wa.me/5521988938894?text=Olá, estou entrando em contato pelo seu site, gostaria de informações" target="_blank">Whatsapp</a></li>
            </ul>
        </nav>
    </div>
</div>
<div class="capa" id="capa">
    <div class="container">
        ...
        <div>
            <h2>Design &amp; Programação</h2>
            <p>Agência WEB com 10 anos de mercado, desenvolvendo <span>sites e sistemas</span> responsivos e com o que há de mais atualizado em <span>design e programação</span>. Trabalhamos com critérios rigorosos e entregamos o melhor que a internet pode oferecer.</p>
            <a href="https://wa.me/5521988938894?text=Olá, estou entrando em contato pelo seu site, gostaria de informações" target="_blank" class="botao bverde"><span><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp" class="svg-inline--fa fa-whatsapp fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"></path></svg> Entrar em contato</span></a>
            <a data-go="clientes" class="botao bazul go"><span><svg style="height: 30px" aria-hidden="true" focusable="false" data-prefix="far" data-icon="bookmark" class="svg-inline--fa fa-bookmark fa-w-12" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M336 0H48C21.49 0 0 21.49 0 48v464l192-112 192 112V48c0-26.51-21.49-48-48-48zm0 428.43l-144-84-144 84V54a6 6 0 0 1 6-6h276c3.314 0 6 2.683 6 5.996V428.43z"></path></svg> Clientes &amp; Parceiros</span></a>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="itens">
            <div class="item">
                ...
                <h4>Websites</h4>
                <p>Layouts extraordinários e responsivos com uma programação impecável. Nosso carro-chefe de produção.</p>
            </div>
            <div class="item">
                ...
                <h4>E-commerces</h4>
                <p>E-commerces com a facilidade de gestão de um site institucional e sistemas de pagamento confiáveis.</p>
            </div>
            <div class="col-xs-6 col-sm-3 item">
                ...
                <p>Designs belíssimos e exclusivos, desenvolvidos com precisão para realçar sua marca em qualquer mídia.</p>
            </div>
            <div class="item">
                ...
                <h4>Sistemas Web</h4>
                <p>Toda segurança de um sistema local com a vantagem do acesso web, tudo sob medida para o que você precisa.</p>
            </div>
            <div class="item">
                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" class="svg-inline--fa fa-google fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg>
                <h4>SEO e SEM</h4>
                <p>Os mecanismos de busca são publicidades gratuitas. Nosso know-how vai te ajudar a <span style="white-space: nowrap;">usá-los</span> corretamente.</p>
            </div>
            <div class="item">
                ...
                <h4>Social Media</h4>
                <p>Adequar é a palavra-chave. Saber qual e como usar cada mídia social para incrementar os acessos e a relevância.</p>
            </div>
            <div class="item">
                ...
                <h4>Consultoria</h4>
                <p>Cada estratégia é única e necessita da contribuição e experiência em diversas áreas para garantir o sucesso.</p>
            </div>
            <div class="item">
                ...
                <p>Utilizando ferramentas de remarketing (Pixel, Business, Ads e Analytics) para divulgar com estratégia.</p>
            </div>
        </div>
    </div>
</div>
<div class="sobre" id="sobre">
    <div class="container">
		...
		<div>
            ...
            <div class="info">
                <h3>Que Mário? <span class="ccinza t48">(:</span></h3>
                <p>Olá, eu me chamo Mário e sou <span class="cazul">Publicitário</span>, <span class="cverde">Desenvolvedor</span> e <span class="claranja">Matemático</span>, dono da Alpaca Web, empresa criada para atender diversas agências parceiras e clientes finais.</p>
                <p>Minha formação multidisciplinar me capacitou para projetar e desenvolver aplicações web (sites e sistemas digitais) e campanhas de Marketing Digital. Os projetos vão desde a fase de pesquisa e briefing, passando pela criação de identidade de marca e peças publicitárias, até o desenvolvimento completo da plataforma online e painel de gestão de conteúdo.</p>
                <p>Trabalho com as mais atuais técnicas de desenvolvimento, dentro dos critérios jurídicos e dos padrões de boas práticas da internet para entregar o melhor que a internet pode oferecer.</p>
            </div>
		</div>
    </div>
</div>
<div class="clientes" id="clientes">
    ...
    <div class="container-full">
        ...
        <div class="item"> <img src="./img/clientes/congressopr2017.png" alt="logo de cliente" class="logo"> </div>
        <div class="item"> <img src="./img/clientes/congressopr2019.png" alt="logo de cliente" class="logo"> </div>
        <div class="item"> <img src="./img/clientes/congressors2017.png" alt="logo de cliente" class="logo"> </div>
        <div class="item"> <img src="./img/clientes/congressosc2016.png" alt="logo de cliente" class="logo"> </div>
...
<div class="credito" id="credito">
	<div class="container">
		...
		<a href="https://wa.me/5521988938894?text=Olá, muito bonito o seu site!" target="_blank" class="botao bverde"><span><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp" class="svg-inline--fa fa-whatsapp fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"></path></svg> Mande um elogio no Whatsapp</span></a>
	</div>
</div>
