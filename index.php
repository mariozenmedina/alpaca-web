...
<div class="topo" id="topo">
    <div class="container">
        <h1><a href=""><img class="logo" src="./img/alpacaweb-inline.svg" alt="Logo da agência Alpaca Web."></a></h1>
        ...
        <nav>
            <ul class="menu">
                ...
                <li><a href="">Trabalhos e Clientes</a></li>
...
<div class="capa" id="capa">
    <div class="container">
        ...
        <div>
            ...
            <p>Agência WEB com 10 anos no mercado, desenvolvendo <span>sites e sistemas</span> responsivos e com o que há de mais atualizado em <span>design e programação</span>. Trabalhamos com critérios rigorosos e entregamos o melhor que a internet pode oferecer.</p>
    ...
    <div class="container">
        ...
        <div class="itens">
            <div class="item">
                ...
                <h4>Websites</h4>
                <p>Layouts extraordinários e responsivos com uma programação impecável. Nosso carro forte de produção.</p>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <h4>Sistemas Web</h4>
                <p>Toda segurança de um sistema local com a vantagem do acesso web. Sistemas sob medida para o que você precisa.</p>
            </div>
            <div class="item">
                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" class="svg-inline--fa fa-google fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg>
                <h4>SEO e SEM</h4>
                <p>Os mecanismos de busca são publicidades gratuitas. Nosso know-how vai te ajudar a usá-los corretamente.</p>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <h4>Consultoria</h4>
                <p>Cada estratégia é única e necessita da contribuição de experiência em diversas áreas para garantir o sucesso.</p>
            </div>
            <div class="item">
                ...
                <p>Na internet os erros marcam para sempre, divulgue com estratégia e conhecimento para ficar longe do perigo.</p>
            </div>
        </div>
    </div>
</div>
